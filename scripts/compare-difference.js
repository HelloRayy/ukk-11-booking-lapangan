// PERAN SCRIPT: Membandingkan screenshot section The Blanca difference lokal dengan target baseline
...
const TARGET_SNAPSHOT = 'tests/snapshots/difference-section-target.png';
const LOCAL_SNAPSHOT = 'tests/snapshots/difference-section-local.png';
