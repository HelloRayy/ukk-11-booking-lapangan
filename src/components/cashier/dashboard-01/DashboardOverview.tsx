...
export default function DashboardOverview({
  ...
  return (
    <div className="space-y-6 animate-fadeIn p-6">
      {/* 1. Baris Judul & Filter Rentang Tanggal Minimalis */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          {/* Pill Periode Berjalan */}
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-zinc-900 border border-zinc-800 text-xs text-zinc-300 font-medium">
            <Calendar className="w-3.5 h-3.5 text-zinc-500" />
            <span>{currentPeriod}</span>
          </div>

          {/* Tombol Cetak Rekap (Icon Button Minimalis) */}
          <button
            type="button"
