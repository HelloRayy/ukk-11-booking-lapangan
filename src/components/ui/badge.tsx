...
function Badge({ className, variant = 'default', ...props }: BadgeProps) {
  const variantStyles = {
    ...
    secondary: 'border-transparent bg-[oklch(0.2593_0.0033_230.84)] text-white',
    destructive: 'border-rose-500/20 bg-rose-500/10 text-rose-400',
    outline: 'border-[oklch(0.2593_0.0033_230.84)] bg-white/5 text-[oklch(0.9235_0.001733_230.685)]',
